...
def main():
    base_london = LondonCreator(min_year=2015, minute_interval=20, exclude_covid=True)\
        .get_or_create_london(pickle_file='simulation/files/london.pickle')
    sm = SimulationManager(city=base_london, n_simulations=10, simulation_id='SIM_BASE_5AM_NO_REBAL')
    sm.run_simulations()
